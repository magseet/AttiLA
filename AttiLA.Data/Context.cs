...
namespace AttiLA.Data
{
    ...
    public class Context
    {
        ...
        /// <summary>
        /// Update the context with the new signals.
        /// </summary>
        ...
        public void Correct(Dictionary<string,uint> signals)
        {
            ...
            // update missing signals of the context
        ...
        /// <summary>
        /// Returns the likelihood value between the signals and the context.
        /// </summary>
        /// <param name="signals"></param>
        /// <returns></returns>
