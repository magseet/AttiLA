...
namespace AttiLA.Data.Services
{
    ...
    public class ContextService : EntityService<Context>
    {
        ...
        /// </summary>
        /// <exception cref="ServiceException">Thrown when the new example is not inserted due to an error.</exception>
        ...
        public void AddScanExample(string contextId, ScanExample scanExample)
        {
            ...
            {
                throw new ServiceException(Properties.Resources.MsgErrorAddScanExample);
            }
        }
